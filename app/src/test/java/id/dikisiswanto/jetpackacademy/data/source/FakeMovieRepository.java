...
public class FakeMovieRepository implements MovieDataSource {
	...
	public FakeMovieRepository(LocalRepository localRepository, @NonNull RemoteRepository remoteRepository, AppExecutors appExecutors) {
		this.localRepository = localRepository;
		this.remoteRepository = remoteRepository;
		this.appExecutors = appExecutors;
	}

	public static FakeMovieRepository getInstance(LocalRepository localRepository, @NonNull RemoteRepository remoteRepository, AppExecutors appExecutors) {
		if (INSTANCE == null) {
